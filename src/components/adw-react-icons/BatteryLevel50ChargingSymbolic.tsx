...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path class="success" d="m 5 9 v 4 h 3 v -1 c 0 -0.53125 0.210938 -1.039062 0.585938 -1.414062 l 1.585937 -1.585938 z m 0 0" fill="#33d17a"/>
...
const AdwBatteryLevel50ChargingSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwBatteryLevel50ChargingSymbolic;
