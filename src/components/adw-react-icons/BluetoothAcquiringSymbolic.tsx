...
const AdwBluetoothAcquiringSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwBluetoothAcquiringSymbolic;
