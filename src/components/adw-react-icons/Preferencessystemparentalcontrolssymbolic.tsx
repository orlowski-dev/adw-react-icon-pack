...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  <g
    ...
    <path
       ...
       style="opacity:1;fill:#2e3436;fill-opacity:1;stroke:none;stroke-width:3.33333325;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:1" />
    <path
       id="rect4002"
       ...
       style="opacity:1;fill:#2e3436;fill-opacity:1;stroke:none;stroke-width:3.33333325;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:1" />
    <path
...
const AdwPreferencessystemparentalcontrolssymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwPreferencessystemparentalcontrolssymbolic;
