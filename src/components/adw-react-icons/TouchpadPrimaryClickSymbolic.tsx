...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    <path d="m 2 11 h 5 v 2 h -3.96875 c -0.597656 0 -1.03125 -0.433594 -1.03125 -1.03125 z m 0 0" fill="#202020" fill-opacity="0.34902"/>
    </svg>
  );
};

const AdwTouchpadPrimaryClickSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwTouchpadPrimaryClickSymbolic;
