...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <g fill="#2e3436">
        <path d="m 9.5 14 v -12 h 5 v 12 z m 0 0" fill-opacity="0.34902"/>
...
const AdwSidebarShowRightSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwSidebarShowRightSymbolic;
