  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        ...
        <path d="m 5.664062 15 h 9.800782 c 0.277344 0 0.5 -0.222656 0.5 -0.5 s -0.222656 -0.5 -0.5 -0.5 h -9.800782 c -0.277343 0 -0.5 0.222656 -0.5 0.5 s 0.222657 0.5 0.5 0.5 z m 0 0"/>
        <path d="m 4.277344 7.007812 l 6.015625 5.992188 c 0.195312 0.195312 0.511719 0.195312 0.707031 0 s 0.195312 -0.511719 0 -0.707031 l -6.015625 -5.996094 c -0.195313 -0.195313 -0.511719 -0.195313 -0.707031 0.003906 c -0.195313 0.195313 -0.195313 0.511719 0 0.707031 z m 0 0"/>
        <path d="m 4.132812 6.152344 l -3.03125 3.257812 l 3.527344 4.402344 l 4.929688 0.1875 l 1.589844 -1.34375 z m 0 0" fill-opacity="0.33"/>
    </g>
    </svg>
  );
};

const AdwEraser3Symbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwEraser3Symbolic;
