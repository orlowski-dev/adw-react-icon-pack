...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        <g fill-rule="evenodd">
            <path d="m 3 0 c -1.644531 0 -3 1.355469 -3 3 s 1.355469 3 3 3 s 3 -1.355469 3 -3 s -1.355469 -3 -3 -3 z m 0 2 c 0.5625 0 1 0.4375 1 1 s -0.4375 1 -1 1 s -1 -0.4375 -1 -1 s 0.4375 -1 1 -1 z m 0 0"/>
        ...
        <path d="m 10 8 c 0 1.105469 -0.894531 2 -2 2 s -2 -0.894531 -2 -2 s 0.894531 -2 2 -2 s 2 0.894531 2 2 z m 0 0" fill-rule="evenodd"/>
    </g>
    </svg>
  );
};

const AdwCenterSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwCenterSymbolic;
