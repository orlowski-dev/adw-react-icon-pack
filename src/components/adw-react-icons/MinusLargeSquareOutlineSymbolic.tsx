  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        ...
        <path d="m 3 7 h 10 v 2 h -10 z m 0 0"/>
    </g>
    </svg>
  );
};

const AdwMinusLargeSquareOutlineSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwMinusLargeSquareOutlineSymbolic;
