...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path class="success" d="m 5 11 v 2 h 3 v -1 c 0 -0.355469 0.09375 -0.699219 0.269531 -1 z m 0 0" fill="#33d17a"/>
...
const AdwBatteryLevel20ChargingSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwBatteryLevel20ChargingSymbolic;
