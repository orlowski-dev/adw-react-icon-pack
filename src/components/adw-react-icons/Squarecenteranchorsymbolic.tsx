...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        <path d="m 1 1 v 14 h 14 v -14 z m 2 2 h 10 v 10 h -10 z m 0 0"/>
...
const AdwSquarecenteranchorsymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwSquarecenteranchorsymbolic;
