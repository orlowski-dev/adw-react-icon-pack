  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        ...
        <path d="m 8 4 l 3 1.132812 v 1.851563 c 0 1.660156 -2 4.015625 -3 4.015625 c -0.902344 0 -3 -2.355469 -3 -4.015625 v -1.851563 z m 0 0"/>
    </g>
    </svg>
  );
};

const AdwScreenPrivacy4Symbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwScreenPrivacy4Symbolic;
