...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path class="success" d="m 5 7 v 6 h 3 v -1 c 0 -0.53125 0.210938 -1.039062 0.585938 -1.414062 l 2.414062 -2.414063 v -1.171875 z m 0 0" fill="#33d17a"/>
...
const AdwBatteryLevel80ChargingSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwBatteryLevel80ChargingSymbolic;
