...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path class="success" d="m 5 10 v 3 h 3 v -1 c 0 -0.53125 0.210938 -1.039062 0.585938 -1.414062 l 0.585937 -0.585938 z m 0 0" fill="#33d17a"/>
...
const AdwBatteryLevel40ChargingSymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwBatteryLevel40ChargingSymbolic;
