...
const SvgTemplate = ({ title, size }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path class="success"  d="m 5 12 v 1 h 3 v -1 z m 0 0" fill="#33d17a"/>
...
const AdwBatterycautionchargingsymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwBatterycautionchargingsymbolic;
