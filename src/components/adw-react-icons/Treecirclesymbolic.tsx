  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        ...
        <path d="m 8 0 c -3.855469 0 -7 3.144531 -7 7 s 3.144531 7 7 7 s 7 -3.144531 7 -7 s -3.144531 -7 -7 -7 z m 0 2 c 2.773438 0 5 2.226562 5 5 s -2.226562 5 -5 5 s -5 -2.226562 -5 -5 s 2.226562 -5 5 -5 z m 0 0"/>
    </g>
    </svg>
  );
};

const AdwTreecirclesymbolic = ({ wrapper, wrapperProps, ...props }: Props) => {
  if (!wrapper) {
...
export default AdwTreecirclesymbolic;
